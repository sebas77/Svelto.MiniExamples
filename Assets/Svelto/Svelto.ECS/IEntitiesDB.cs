...
namespace Svelto.ECS
{
    public interface IEntitiesDB: IObsoleteInterfaceDb
    {
        ...
        /// <summary>
        /// Temporary design for multiple entity struct queries, it's going to change
        /// </summary>
        ...
        /// <typeparam name="T"></typeparam>
        void ExecuteOnAllEntities<T>(Action<T[], int, IEntitiesDB> action) where T : IEntityStruct;
    ...
    public delegate void AllEntitiesAction<T, W>(T[] entities, int count, IEntitiesDB db, ref W value);
