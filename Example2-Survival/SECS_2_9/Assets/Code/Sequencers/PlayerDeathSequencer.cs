...
namespace Svelto.ECS.Example.Survive
{
    ...
    {
        public void SetSequence(PlayerDeathEngine     playerDeathEngine,     PlayerMovementEngine playerMovementEngine,
                                PlayerAnimationEngine playerAnimationEngine, EnemyAnimationEngine enemyAnimationEngine,
                                DamageSoundEngine     damageSoundEngine,     HUDEngine            hudEngine)
        {
