...
namespace UnityStandardAssets.CrossPlatformInput
{
    public static class CrossPlatformInputManager
    {
        ...
        public static VirtualAxis VirtualAxisReference(string name) { return activeInput.VirtualAxisReference(name); }
        ...
        public class VirtualAxis
        {
            ...
            public float GetValue { get; set; }


            public float GetValueRaw { get { return GetValue; } }
            ...
            public void Update(float value) { GetValue = value; }
        }
