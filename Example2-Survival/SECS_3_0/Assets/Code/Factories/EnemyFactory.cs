        ...
        public IEnumerator Build(EnemySpawnData enemySpawnData, EnemyAttackComponent EnemyAttackComponent)
        {
            ...
            implementors.Add(enemyGO.AddComponent<EGIDHolderImplementor>());
             ...
             var initializer = _entityFactory
                   .BuildEntity<EnemyEntityDescriptor>(new EGID(_enemiesCreated++, ECSGroups.EnemiesGroup),
                                                        implementors);
             ...
             initializer.Init(new HealthComponent {currentHealth  = 100});
             initializer.Init(new ScoreValueComponent {scoreValue = (int) (enemySpawnData.targetType + 1) * 10});
             initializer.Init(new EnemyComponent {enemyType       = enemySpawnData.targetType});
