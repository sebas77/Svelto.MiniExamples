...
nuget_pack:
	...
	# Build for Debug
	dotnet pack /p:Version=1.0.0 -o temp/bin/debug Svelto.Common.csproj -c Debug
	...
	# Build for Release
	dotnet pack /p:Version=1.0.0 -o temp/bin/release Svelto.Common.csproj -c Release
	...
	# Compile into nuget
	dotnet pack /p:PackageVersion=2.0.0 -o . Svelto.Common.csproj -c Custom
	make nuget_clean
