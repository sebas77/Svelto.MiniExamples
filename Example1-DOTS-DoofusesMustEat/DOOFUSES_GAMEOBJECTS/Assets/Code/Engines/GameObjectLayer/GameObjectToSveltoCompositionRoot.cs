...
{
    static class GameObjectToSveltoCompositionRoot
    {
       ...
       , out GameObjectManager gameObjectManager)
        ...
        static void AddSveltoEngineToTick(IJobifiedEngine engine, EnginesRoot enginesRoot, FasterList<IJobifiedEngine> enginesToTick)
        {
