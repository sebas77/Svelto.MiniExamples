...
namespace Svelto.ECS.MiniExamples.Doofuses.ComputeSharp
{
    ...
    public class LookingForFoodDoofusesEngine : IQueryingEntitiesEngine, IUpdateEngine
    {
        ...
        public void Step(in float _param)
        {
            ...
            CreateJobForDoofusesAndFood(GameGroups.RED_FOOD_NOT_EATEN.Groups, GameGroups.RED_DOOFUSES_NOT_EATING.Groups,
                GameGroups.RED_DOOFUSES_EATING.BuildGroup, GameGroups.RED_FOOD_EATEN.BuildGroup);
            ...
            CreateJobForDoofusesAndFood(GameGroups.BLUE_FOOD_NOT_EATEN.Groups,
                GameGroups.BLUE_DOOFUSES_NOT_EATING.Groups, GameGroups.BLUE_DOOFUSES_EATING.BuildGroup,
        ...
        /// </summary>
        void CreateJobForDoofusesAndFood(FasterReadOnlyList<ExclusiveGroupStruct> availableFood,
            ...
            ExclusiveBuildGroup eatenFoodGroup)
        {
                        ...
                        .QueryEntities<PositionComponent>(availableFood))
            {
                            ...
                            .QueryEntities<MealInfoComponent>(availableDoofuses))
                {
                    ...
                    {
                        _doofuses = doofuses, _doofusesegids = egids, _food = foodEntities, _functions = _functions,
                        _doofuseMealLockedGroup = eatingDoofusesGroup, _lockedFood = eatenFoodGroup,
                        _fromFoodGroup = fromGroup, _fromDoofusesGroup = fromDoofusesGroup, _count = willEatDoofusesCount
                    }.Execute();
                }
            }
        }
            ...
            public void Execute()
            {
                for (int index = 0; index < _count; index++)
                {
                    ...
                    _functions.SwapEntityGroup<DoofusEntityDescriptor>(
                        new EGID(@_doofusesegids[index], _fromDoofusesGroup), _doofuseMealLockedGroup);
