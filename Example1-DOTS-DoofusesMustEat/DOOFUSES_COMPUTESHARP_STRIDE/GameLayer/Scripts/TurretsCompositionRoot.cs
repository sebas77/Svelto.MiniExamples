...
using Stride.Engine;
using Stride.Games;
using Svelto.ECS.MiniExamples.Example1C;
...
namespace Svelto.ECS.MiniExamples.Turrets
{
    public class TurretsCompositionRoot : Game
    {
        ...
        protected override void BeginRun()
        {
            ...
            GameCompositionRoot((int)blueDoofusPrefab);
        }

        void GameCompositionRoot(int blueDoofusPrefab)
        {
            var entityFactory = _enginesRoot.GenerateEntityFactory();
...
//            blueFootPrefab   = Content.Load<Entity>("entity1");
            ...
            blueDoofusPrefab = gom.LoadAndRegisterPrefab("Capsule_2", out _);
        }
