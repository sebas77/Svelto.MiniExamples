...
{
    public struct SerializersInfo<SerializationEnum>
            where SerializationEnum : Enum
    {
            ...
            where T : unmanaged, IEntityComponent
    {
          ...
          , int serializationType)
        {
            ...
            serializationData.data.IncrementCountBy((uint)componentSerializer.size);
        ...
        public void Deserialize(ISerializationData serializationData, in EntityInitializer initializer
          , int serializationType)
        {
            IComponentSerializer<T> componentSerializer = _serializers[(int)serializationType];
