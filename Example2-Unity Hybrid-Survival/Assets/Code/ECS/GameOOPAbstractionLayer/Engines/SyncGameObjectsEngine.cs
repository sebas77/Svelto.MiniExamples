...
namespace Svelto.ECS.Example.Survive.OOPLayer
{
    public class SyncGameObjectsEngine: IQueryingEntitiesEngine, IStepEngine
    {
        ...
        /// <summary>
        /// I was lazy here, each method should have been an engine
        /// </summary>
        public void Step()
        {
            SyncEntitiesPhysicToObjects();

            SyncEntitiesAnimationStatesToObjects();

            SyncEntitiesPositionToObjects();
        }

        void SyncEntitiesPhysicToObjects()
        {
        ...
        void SyncEntitiesPositionToObjects()
        {
            ...
            //position only sync
            foreach (var ((entity, positions, count), currentGroup) in entitiesDB
        ...
        void SyncEntitiesAnimationStatesToObjects()
        {
            LocalFasterReadOnlyList<ExclusiveGroupStruct> groups;
