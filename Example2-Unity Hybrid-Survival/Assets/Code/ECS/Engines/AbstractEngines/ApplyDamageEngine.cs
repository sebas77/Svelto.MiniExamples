...
namespace Svelto.ECS.Example.Survive.Characters
{
    ...
    [Sequenced(nameof(EnginesEnum.ApplyDamageEngine))]
    public class ApplyDamageEngine : IQueryingEntitiesEngine, IStepEngine
    {
        public void Ready()
        {
        ...
        public ApplyDamageEngine(IEntityStreamConsumerFactory consumerFactory)
        {
