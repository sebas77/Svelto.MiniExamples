...
namespace Svelto.ECS.Example.Survive.Player
{
    public class PlayerMovementEngine : IQueryingEntitiesEngine, IStepEngine
    {
            ...
            void EnsureRefIsValid()
            {
                                 ...
                                 PlayerEntityComponent>(Player.Groups))
                {
                    for (int i = 0; i < count; i++)
                    {
                        ...
                        Turning(
                            ref entitiesDB.QueryEntity<CameraEntityViewComponent>(cameraReference[i].cameraReference
        ...
        void Turning(ref CameraEntityViewComponent cameraInfo, ref PlayerEntityComponent playerComponent)
        {
