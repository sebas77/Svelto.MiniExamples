...
namespace Svelto.ECS.Example.Survive.Player
{
    ...
    {
        public PlayerSpawnerEngine(GameObjectResourceManager gameObjectResourceManager, IEntityFactory entityFactory)
        {
        ...
        void BuildCameraEntity(ref EntityInitializer playerID, uint camera)
        {
