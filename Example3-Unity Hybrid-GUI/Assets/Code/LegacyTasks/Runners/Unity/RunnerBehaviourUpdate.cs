...
namespace Svelto.Tasks.Unity.Internal
{
    class RunnerBehaviourUpdate : MonoBehaviour
    {
        ...
        static void ExecuteRoutines(ThreadSafeFasterList<FasterList<IProcessSveltoTasks>> list,
        ...
        readonly ThreadSafeFasterList<FasterList<IProcessSveltoTasks>> _earlyProcesses =
            new ThreadSafeFasterList<FasterList<IProcessSveltoTasks>>();

        readonly ThreadSafeFasterList<FasterList<IProcessSveltoTasks>> _endOfFrameRoutines =
            new ThreadSafeFasterList<FasterList<IProcessSveltoTasks>>();

        readonly ThreadSafeFasterList<FasterList<IProcessSveltoTasks>> _updateProcesses =
            new ThreadSafeFasterList<FasterList<IProcessSveltoTasks>>();

        readonly ThreadSafeFasterList<FasterList<IProcessSveltoTasks>> _lateRoutines =
            new ThreadSafeFasterList<FasterList<IProcessSveltoTasks>>();

        readonly ThreadSafeFasterList<FasterList<IProcessSveltoTasks>> _physicRoutines =
            new ThreadSafeFasterList<FasterList<IProcessSveltoTasks>>();

        readonly ThreadSafeFasterList<FasterList<IProcessSveltoTasks>> _coroutineProcesses =
            new ThreadSafeFasterList<FasterList<IProcessSveltoTasks>>();

        readonly ThreadSafeFasterList<FasterList<IProcessSveltoTasks>> _onGuiRoutines =
            new ThreadSafeFasterList<FasterList<IProcessSveltoTasks>>();
    }
}
#endif