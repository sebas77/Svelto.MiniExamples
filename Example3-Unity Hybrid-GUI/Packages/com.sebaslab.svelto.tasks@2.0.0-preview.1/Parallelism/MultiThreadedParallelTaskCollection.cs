...
namespace Svelto.Tasks.Parallelism
{
    ...
    public class MultiThreadedParallelTaskCollection<TTask> : IEnumerator<TaskContract> where TTask:IEnumerator<TaskContract> 
    {
        ...
        {
            if (System.Threading.Volatile.Read(ref _isDisposed)) return false;
        ...
        public void Reset()
        {
            DBC.Tasks.Check.Require(System.Threading.Volatile.Read(ref _isDisposed) == false, 
        ...
        public void Dispose()
        {
            if (System.Threading.Volatile.Read(ref _isDisposed) == true) return;
