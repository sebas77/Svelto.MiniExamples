...
namespace Svelto.ECS
{
    public static class EntityDBExtensions
    {
        ...
        public static NativeGroupsEnumerable<T1, T2, T3, T4> NativeGroupsIterator
            <T1, T2, T3, T4>(this EntitiesDB db, ExclusiveGroup[] groups)
            where T1 : unmanaged, IEntityComponent where T2 : unmanaged, IEntityComponent
        ...
        public static NativeGroupsEnumerable<T1> NativeGroupsIterator<T1>(this EntitiesDB db, ExclusiveGroup[] groups)
        ...
        public static NB<T> NativeEntitiesBuffer<T>(this EntitiesDB db, ExclusiveGroup @group)
            where T : unmanaged, IEntityComponent
        {
            return db.QueryEntities<T>(group).ToNativeBuffer<T>();
        }
        
        public static BT<NB<T1>, NB<T2>> NativeEntitiesBuffer<T1, T2>(this EntitiesDB db, ExclusiveGroup @group)
            where T1 : unmanaged, IEntityComponent
        ...
        public static BT<NB<T1>, NB<T2>, NB<T3>> NativeEntitiesBuffer<T1, T2, T3>(this EntitiesDB db, ExclusiveGroup @group)
            where T1 : unmanaged, IEntityComponent
            where T2 : unmanaged, IEntityComponent
            where T3 : unmanaged, IEntityComponent
        {
