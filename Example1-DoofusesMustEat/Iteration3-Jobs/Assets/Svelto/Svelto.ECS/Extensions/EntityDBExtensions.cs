namespace Svelto.ECS
{
    ...
    {
        public static NativeGroupsEnumerable<T1, T2> NativeGroupsIterator<T1, T2>(this EntitiesDB db, ExclusiveGroup[] groups)
            ...
            where T1 : unmanaged, IEntityComponent where T2 : unmanaged, IEntityComponent where T3 : unmanaged, IEntityComponent
        {
         ...
         public static NativeAllGroupsEnumerable<T1> NativeGroupsIterator<T1>(this EntitiesDB db) where T1 : unmanaged, IEntityComponent
         {
