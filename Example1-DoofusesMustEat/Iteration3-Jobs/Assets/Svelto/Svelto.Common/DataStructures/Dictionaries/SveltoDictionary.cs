...
namespace Svelto.DataStructures
{
    ...
    public class SveltoDictionary<TKey, TValue>: IDisposable where TKey : IEquatable<TKey>
    {
        ...
        {
            if (allocationStrategy.IsUnmanaged == false)
            {
        ...
        {
            return new NativeFasterDictionary<TK, TV>(_buckets, (IBuffer<TV>) _values.ToBuffer(), _valuesInfo.ToNativeArray(), _freeValueCellIndex);
        }
