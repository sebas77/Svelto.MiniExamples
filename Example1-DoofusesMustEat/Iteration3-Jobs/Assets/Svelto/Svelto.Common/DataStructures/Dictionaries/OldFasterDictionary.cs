...
namespace Svelto.DataStructures
{
    ...
    public sealed class OldFasterDictionary<TKey, TValue> : IFasterDictionary<TKey, TValue> where TKey : IEquatable<TKey>
    {
        public OldFasterDictionary(uint size)
        {
        ...
        {
            public FasterDictionaryKeyValueEnumerator(OldFasterDictionary<TKey, TValue> dic) : this()
            {
                _dic = dic;
                _index = -1;
            ...
            readonly OldFasterDictionary<TKey, TValue> _dic;
            readonly int                            _count;
